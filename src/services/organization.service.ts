...
const organizationService={
    create(name:string,location:string,industry:string):Promise<Organization>{
        return new Promise((resolve,reject)=>{
            const sql="INSERT INTO organizations (name,location,industry) VALUES (?, ?, ?)";
    ...
    update(id:number,name:string,location:string,industry:string):Promise<Organization|null>{
        return new Promise((resolve,reject)=>{
